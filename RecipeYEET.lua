...
local modName = "LockdownTweaks"

local recipesToYeet = {}

recipesToYeet["Create Lawgiver MKII Clip"] = true

recipesToYeet["Create Lawgiver MKII"] = true

recipesToYeet["Make Backpack Attachable Item"] = true

recipesToYeet["Place Beets in Cooking Pot"] = true
